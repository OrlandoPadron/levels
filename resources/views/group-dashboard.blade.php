<div class="content-group-dashboard" x-data="{openShowProfileData: false, openNewPlan: false, sectionTab: 'mensajes', addMembers: false, addTutorshipSession: false,}">
        ...
        <div class="container-dashboard">
            <div class="navbar-dashboard-menu">
                <ul id="navbar-dashboard-items">
                    ...
                    <li id="noticias-navbar" onclick="changeUrlParameters('cuotas')" x-on:click.prevent @click="sectionTab = 'mensajes'" :class="{'active-dashboard': sectionTab === 'mensajes'}"><a href="#">Mensajes</a></li>
    ...
    <div class="content-dashboard">
        <div id="container-dashboard" class="container-dashboard">
            ...
            <div id="mensajes-section-container" x-show.transition.in.opacity.duration.500ms="sectionTab === 'mensajes'">
                @include('sections_groups.messages')
            </div>
