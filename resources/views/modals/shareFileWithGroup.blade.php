           ...
           <div class="modal-body">
                <div class="modal-body-container">
                    <div class="item-with-select">
                        ...
                        <p>Sólo aparecerán los archivos que hayas subido anteriormente a tu perfil y que no hayas compartido ya con el grupo.</p>
                        <select onchange= "changeUI('share')" name="userFiles" id="filesNotShared">
                            <option selected value="0"> -- Archivo no seleccionado --</option>
                            @foreach(getFilesNotSharedWithGroup(Auth::user()->id, $group->id) as $key => $file)
                    ...
                    <div class="modal-buttons">
                        <div class="principal-button">
                            ...
                            onclick="shareFileWithGroup({{$group->id}})">Compartir archivo</button>
                        </div>
                    </div>
