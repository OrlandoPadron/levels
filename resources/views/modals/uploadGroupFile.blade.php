           ...
           <div class="modal-body">
                <div class="modal-body-container">
                    <div class="item-with-button-add-file">
                        <button class="soft-btn" onclick="document.getElementById('group-file-upload').click();">Seleccionar archivo</button>
                        <p id="group-selected-file-name">Ningún archivo seleccionado</p>
                        <i id="group-file-load-status-icon" class="fas fa-check-circle"></i>
                        <input onchange="changeUI('groupUpload')" id="group-file-upload" name="fileuploaded" type="file" 
                    ...
                    <div class="item-with-input">
                        ...
                        <input type="text" name="title" id="group-file-name-input" placeholder="Nombre del archivo" required>
                    </div>
                    <div class="item-with-progressbar">
                        <p>Estado de la subida</p>
                        <progress value="0" max="100" id="group-uploader">0%</progress>

                    </div>
                    <div class="modal-buttons">
                        <div class="principal-button">
                            <button disabled class="btn-add-basic" id="group-upload-btn" type="submit"
                            onclick="uploadFile({{Auth::user()->id}}, {{$group->id}}, 'GroupFileSection')">Subir archivo</button>
                    </div>
